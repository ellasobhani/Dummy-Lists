...
public class TestLinkedList {
	...
	public static void addTest(LinkedList<String> list) {
		...
		// note: index out of bounds error covered by assert in method call
	}
	 ...
	 *
	 * @param list an empty list
	 * @pre list is empty and not null
	 */
	public static void removeTest(LinkedList<String> list) {
		...
		// list is empty, so removing "0" should return null value without
		// throwing exception
		list.remove("0");
	 ...
	 * @pre list is empty and not null
	 */
	public static void removeIndexTest(LinkedList<String> list) {
		assert list.size() == 0;
	...
	public static void setTest(LinkedList<String> list) {
		...
		// note: corner case "i out of range" handled by assert in method call
	}
	...
	public static void indexingTest(LinkedList<String> list) {
		...
		System.out.println("\tReceived: " + list.indexOf("6"));

		System.out.println("\tExpected: 7");
		System.out.println("\tReceived: " + list.lastIndexOf("1"));

		System.out.println("\tExpected: -1");
		System.out.println("\tReceived: " + list.lastIndexOf("6"));

	}

	/**
	 * Tests get(i) functionality
	 * This test relies on addList, so please thoroughly
	 * test that method first.
	 *
	 * Note: getNode(i) is tested implicitly through this method.
	 * getNode(i) is a private method, so we do not test it explicitly.
	 *
	 * @param list an empty list
	 * @pre list is empty and not null
	 */
	public static void getTest(LinkedList<String> list) {
		Assert.pre(list.size() == 0, "list is empty");
		...
		System.out.println("\tReceived: " + list.get(12));
	}


	/**
	 * Tests contains(value) functionality
	 * This test relies on addList, so please thoroughly
	 * test that method first.
	 *
	 * @param list an empty list
	 * @pre list list is empty and not null
	 */
	public static void containsTest(LinkedList<String> list) {
		Assert.pre(list.size() == 0, "list is empty");
		...
		System.out.println("\tReceived: " + list.contains(String.valueOf(5)));

		// contains 10?
		System.out.println("\tExpected: false");
		System.out.println("\tReceived: " + list.contains(String.valueOf(10)));
	}
